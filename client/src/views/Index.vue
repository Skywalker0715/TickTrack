      ...
      >
        ...
        >
          ...
          <div class="container relative mx-auto flex flex-wrap items-center">
            <div class="w-full lg:w-6/12 px-4 text-left text-white">
              <h1 class="text-5xl font-semibold mb-4">Aplikasi TicketReply</h1>
              <p class="text-lg mb-6">
                Solusi mudah dan cepat untuk manajemen tiket Anda.
              </p>
              <button
                class="bg-emerald-500 text-white font-bold uppercase px-6 py-3 rounded shadow hover:shadow-lg transition duration-300"
              >
                Get Started
              </button>
            </div>
            ...
            <div class="w-full md:w-5/12 ml-auto mr-auto px-4">
              <div class="md:pr-12">
                ...
                <p class="mt-4 text-lg leading-relaxed text-blueGray-500">
                  ...
                  good to go. Just make sure you enable them first via JavaScript.
                </p>
